  ...
  return (
    <Fragment>
      ...
      <div className={ondontoCss["odont__above"]}>
        ...
        {odontogramaEditable?.thee_14_to_18.map((ondont_tooth: any, index : any) => (
    ...
    {odontogramaEditable?.thee_11_to_13.map((ondont_tooth: any, index : any) => (
          <div className={ondontoCss["tooth__frame"]} 
            key={index}
            onClick={()=>{
              console.log("halos")
      ...
      <div className={ondontoCss["odont__below"]}>
        <div className={ondontoCss["odont__left"]}>
        {odontogramaEditable?.thee_44_to_48.map((ondont_tooth: any, index : any) => (
          <div className={ondontoCss["tooth__frame"]} 
            key={index}
            onClick={()=>{
              console.log("halos")
        ...
        {odontogramaEditable?.thee_41_to_43.map((ondont_tooth: any, index : any) => (
              <div className={ondontoCss["tooth__frame"]} 
                key={index}
                onClick={()=>{
                  console.log("halos")
